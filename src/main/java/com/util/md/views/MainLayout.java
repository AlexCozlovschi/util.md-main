...
import com.util.md.views.masterManager.MasterView;
...
import com.util.md.views.main.MainView;
import com.util.md.views.login.LoginView;
...
public class MainLayout extends AppLayout {
    ...
    private List<RouterLink> createLinks() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                new MenuItemInfo("Main", "la la-globe", MainView.class),
    ...
    private Footer createFooter() {
        ...
        if (maybeUser.isPresent()) {
            ...
            Avatar avatar = new Avatar(user.getName(), data.getPicture());
